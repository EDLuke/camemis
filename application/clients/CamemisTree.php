...
class CamemisTree {
    ...
    public function renderJS() {
        ...
        if ($this->setTBarItems()) {
            ...
            $js .= "Ext.apply(this, {" . $this->setListenersCheckchange() . "})
            " . $this->setTreeNode() . "
            " . $this->getObjectName() . ".superclass.initComponent.apply(this, arguments);";
            $js .= "}";
        }
    ...
    protected function onAddFolder() {
        ...
        $js .= "parent.Ext.MessageBox.prompt('" . ADD_A_NEW_FOLDER . "', '" . PLEASE_ENTER_NEW_NAME . "', showResultText);";
    ...
    protected function setOnTBarAddParentItem() {
        ...
        $js .= "parent.Ext.MessageBox.prompt('" . ADD_A_NEW_ITEM . "', '" . PLEASE_ENTER_NEW_NAME . "', showResultText);";
        $js .= "function showResultText(btn,text){";
        $js .= "if (btn == 'ok'){";
        $js .= "if (text !=''){";
        $js .= "var connection = new Ext.data.Connection();";
    ...
    protected function onRemoveNode() {
        ...
        $js .= "clickId = this.getSelectionModel().getSelectedNode().attributes.id;";
        $js .= "parent.Ext.MessageBox.confirm('" . CONFIRM . "', '" . MSG_DO_YOU_REALLY_WANNT_TO_RUN_THIS . "', showResult);";
        ...
        if ($this->onEmbeddedRemoveEvents)
