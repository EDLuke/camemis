...
class CamemisSchoolTree {
    ...
    public function renderJS() {
        ...
        if ($this->isCrediSystem) {
            $js .= "," . $this->onAddQualification() . "";
            $js .= "," . $this->onAddCreditSchoolyear() . "";
            $js .= "," . $this->onAddSubject() . "";
            $js .= "," . $this->onAddClass() . "";
            $js .= "," . $this->onExpand() . "";
            $js .= "," . $this->onCollapse() . "";
            ...
            $js .= "," . $this->onAddCampus() . "";
            $js .= "," . $this->onAddGrade() . "";
            $js .= "," . $this->onAddTraditionalSchoolyear() . "";
            $js .= "," . $this->onAddClass() . "";
            $js .= "," . $this->onExpand() . "";
            $js .= "," . $this->onCollapse() . "";
            $js .= "," . $this->onRemoveNode() . "";
    ...
    protected function onAddCampus() {

        $js = "";
        $js .= "onAddCampus: function(){";
        $js .= "var actionNode = this.getSelectionModel().getSelectedNode();";
        $js .= "var clickId = 0;";
        $js .= "var url = '" . $this->utiles->buildURL('academic/addcampus', false, true) . "&system=0&objectId=new&parentId=' + clickId;";
        $js .= "clickOpenPage('center','" . ADD_A_NEW_CAMPUS_SCHOOL . "', url);";
        $js .= "}";

        return $js;
    }

    protected function onAddQualification() {

        $js = "";
        $js .= "onAddQualification: function(){";
        $js .= "var actionNode = this.getSelectionModel().getSelectedNode();";
        $js .= "var clickId = 0;";
        $js .= "var url = '" . $this->utiles->buildURL('academic/addcampus', false, true) . "&system=1&objectId=new&parentId=' + clickId;";
        $js .= "clickOpenPage('center','" . ADD_NEW_QUALIFICATION . "', url);";
        $js .= "}";
    ...
    protected function onAddGrade() {
        ...
        $js .= "var url = '" . $this->utiles->buildURL('academic/addgrade', false, true) . "&system=0&parentId=' + clickId + '&academictype=' + academictype ;";
    ...
    public function onAddTraditionalSchoolyear() {
        ...
        $js .= "var clickId = actionNode.attributes.id;";
        $js .= "var url = '" . $this->utiles->buildURL('academic/addschoolyear', false, true) . "&system=0&parentId=' + clickId + '&term_number=' + term_number;";
    ...
    public function onAddCreditSchoolyear() {
        ...
        $js .= "var term_number = actionNode.attributes.term_number;";
        $js .= "var clickId = actionNode.attributes.id;";
        $js .= "var url = '" . $this->utiles->buildURL('academic/addschoolyear', false, true) . "&system=1&parentId=' + clickId + '&term_number=' + term_number;";
        $js .= "clickOpenPage('center','" . ADD_A_NEW_SCHOOL_YEAR . "', url);";
        $js .= "}";
    ...
    protected function onAddSubject() {

        $js = "";
        $js .= "onAddSubject: function(){";
        $js .= "var actionNode = this.getSelectionModel().getSelectedNode();";
        $js .= "var clickId = actionNode.attributes.id;";
        $js .= "var url = '" . $this->utiles->buildURL('academic/addsubject', false, true) . "&system=1&parentId=' + clickId + '&objecttype=SUBJECT';";
        $js .= "clickOpenPage('center','" . ADD_SUBJECTS . "', url);";
        $js .= "}";
    ...
    protected function onRemoveNode() {
        ...
        $js .= "parentId = this.getSelectionModel().getSelectedNode().attributes.parentId;";
    ...
    protected function getExtMenu() {
        ...
        if ($this->isCrediSystem) {
            $this->addMenuItems($this->getMenuOnCreditSchoolyear());
            $this->addMenuItems($this->getMenuOnAddSubject());
            $this->addMenuItems($this->getMenuOnAddClass());
        } else {
            $this->addMenuItems($this->getMenuOnAddGrade());
            $this->addMenuItems($this->getMenuOnTraditionalSchoolyear());
            $this->addMenuItems($this->getMenuOnAddClass());
        }
        ...
        if ($this->isCrediSystem) {
            $js .= "
                ...
                " . $this->addQualificationMenuItemsGet() . "
                " . $this->addCreditSchoolyearMenuItemsGet() . "
                " . $this->addSubjectMenuItemsGet() . "
                " . $this->addGroupMenuItemsGet() . "
            ...
            $js .= "
                ...
                " . $this->addTraditionalSchoolyearMenuItemsGet() . "
    ...
    protected function getMenuOnAddCampus() {

        $js = "";
        $js .= "id:'campus'";
        $js .= ",scope:this";
        $js .= ",handler: this.onAddCampus";
        $js .= ",iconCls:'icon-folder_add'";
        $js .= ",text:'<b>" . ADD_A_NEW_CAMPUS_SCHOOL . "</b>'";

        return $js;
    }

    protected function getMenuOnAddQualification() {

        $js = "";
        $js .= "id:'campus'";
        $js .= ",scope:this";
        $js .= ",handler: this.onAddQualification";
        $js .= ",iconCls:'icon-folder_add'";
        $js .= ",text:'<b>" . ADD_NEW_QUALIFICATION . "</b>'";

        return $js;
    }

    protected function getMenuOnAddSubject() {

        $js = "";
        $js .= "id:'subject'";
        $js .= ",scope:this";
        $js .= ",handler: this.onAddSubject";
        $js .= ",iconCls:'icon-star_yellow_add'";
        $js .= ",text:'<b>" . SUBJECT . "</b>'";
    ...
    protected function getMenuOnTraditionalSchoolyear() {
    ...
    protected function getMenuOnCreditSchoolyear() {
    ...
    protected function addTraditionalSchoolyearMenuItemsGet() {
    ...
    protected function addCreditSchoolyearMenuItemsGet() {

        $js = "";
        $js .= "if (node.attributes.objecttype == 'SCHOOLYEAR'){";
        $js .= "this.menu.items.get('schoolyear')['disable']();";
        $js .= "this.menu.items.get('subject')['" . $this->createStatus() . "']();";
    ...
    protected function addQualificationMenuItemsGet() {

        $js = "";
        $js .= "if (node.attributes.objecttype == 'CAMPUS'){";
        $js .= "this.menu.items.get('schoolyear')['" . $this->createStatus() . "']();";
        $js .= "this.menu.items.get('subject')['disable']();";
        $js .= "this.menu.items.get('class')['disable']();";
        $js .= "}";
    ...
    protected function addGroupMenuItemsGet() {
    ...
    protected function addSubjectMenuItemsGet() {
        ...
        $js = "";
        $js .= "if (node.attributes.objecttype == 'SUBJECT'){";
        $js .= "this.menu.items.get('schoolyear')['disable']();";
        $js .= "this.menu.items.get('subject')['disable']();";
        $js .= "this.menu.items.get('class')['" . $this->createStatus() . "']();";
        $js .= "}";
