...
Class cumulativeLineChart {
    ...
    function __construct($name, $dataSet, $chartSVG, $showControls) {
    ...
    public function rendererChart() {
        ...
        $js = "
        nv.addGraph(function() {
            var " . $this->name . " = nv.models.cumulativeLineChart()
            .showControls(" . $this->showControls . ")
