...
class CamemisExtraClassTree {
    ...
    protected function onaddprogram() {
        ...
        $js .= "var clickId = 0;";
        $js .= "var url = '" . $this->utiles->buildURL('extraclass/addprogram', array("objectId" => "new", "template" => "PROGRAM"), true) . "&parentId=' + clickId;";
    ...
    protected function onAddLevel() {
        ...
        $js .= "var url = '" . $this->utiles->buildURL('extraclass/addprogram', array("objectId" => "new", "template" => "LEVEL"), true) . "&parentId=' + clickId;";
    ...
    public function onAddTerm() {
        ...
        $js .= "var clickId = actionNode.attributes.id;";
        $js .= "var url = '" . $this->utiles->buildURL('extraclass/addprogram', array("objectId" => "new", "template" => "TERM"), true) . "&parentId=' + clickId;";
    ...
    protected function onAddClass() {
        ...
        $js .= "var actionNode = this.getSelectionModel().getSelectedNode();";
        $js .= "var clickId = actionNode.attributes.id;";
        $js .= "var url = '" . $this->utiles->buildURL('extraclass/addprogram', array("objectId" => "new", "template" => "CLASS"), true) . "&parentId=' + clickId + '&objecttype=CLASS';";
