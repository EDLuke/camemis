...
require_once 'models/app_university/sms/SMSSettingDBAccess.php';
require_once 'models/app_university/sms/SendSMSDBAccess.php';
require_once 'models/app_university/sms/UserSMSDBAccess.php';
...
class SmsController extends Zend_Controller_Action {
    ...
    public function init() {
        ...
        if ($this->_getParam('subscriptionId')) {
            $this->subscriptionId = $this->_getParam('subscriptionId');
        }
    }
    ...
    public function smssubscriptionAction() {
        //UserAuth::actionPermint($this->_request, "SMS_MANAGEMENT");
        $this->view->subscriptionId = $this->subscriptionId;
    }
    ...
    public function jsonloadAction() {
        ...
        switch ($this->REQUEST->getPost('cmd')) {
            ...
            case "jsonLoadSMSSubscription":
                $jsondata = SMSDBAccess::jsonLoadSMSSubscription($this->REQUEST->getPost('subscriptionId'));
                break;

            case "jsonListSubscriptons":
                $jsondata = SMSDBAccess::jsonListSubscriptons($this->REQUEST->getPost());
                break;
        }
    ...
    public function jsonsaveAction() {
        ...
        switch ($this->REQUEST->getPost('cmd')) {
            ...
            case "jsonActionSMSSubscription":
                $jsondata = SMSDBAccess::jsonActionSMSSubscription($this->REQUEST->getPost());
                break;
        }
