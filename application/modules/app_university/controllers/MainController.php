...
require_once 'models/app_university/user/UserMemberDBAccess.php';
...
class MainController extends Zend_Controller_Action {
    ...
    public function indexAction()
    {
        ...
        $this->view->MAIN_COMMUNICATION = $this->UTILES->buildURL(
                'communication'
                , array()
        );

        $this->view->MAIN_BULLETIN_BOARD = $this->UTILES->buildURL(
    ...
    private function studentModul()
    {
        ...
        $STUDENT_SETTING = "{
            ...
            ,iconCls:'icon-wrench_orange'
            ,handler: function(){
                addTab('SCHOOL_SETTINGS','" . STUDENT_MODUL . " &raquo; " . STUDENT_SETTING . "','" . $this->UTILES->buildURL('dataset/setting', array('personType' => 'STUDENT')) . "');
            }
        } ";
        ...
        //$CHOOSE_STUDENT_MODUL[] = "" . $ALUMNI_MANAGEMENT . "";
        ...
        if (UserAuth::getACLValue("PRE_SCHOOL"))
    ...
    private function staffModul()
    {
        ...
        $STAFF_SETTING = "{
            ...
            ,iconCls:'icon-wrench_orange'
            ,handler: function(){
                addTab('STAFF_SETTING','" . STAFF_SETTING . "','" . $this->UTILES->buildURL('dataset/setting', array('personType' => 'STAFF')) . "');
            }
        } ";
    ...
    private function academicModul()
    {
        ...
        //$TBAR_ACADEMIC_PERFORMANCES_ITEMS = implode(",", $CHOOSE_ACADEMIC_PERFORMANCES_ITEMS);
        ////////////////////////////////////////////////////////////////////////
        //ACADEMIC_MODUL
        ////////////////////////////////////////////////////////////////////////
        ...
        $EXTRA_CLASS_MANAGEMENT = "{
            ...
            ,handler: function(){
                addTab('EXTRA_EDUCATION','" . ACADEMIC_MODUL . " &raquo; " . EXTRA_CLASS_MANAGEMENT . "','" . $this->UTILES->buildURL('extraclass', array()) . "');
            }
        } ";
...
//            {
//                $CHOOSE_ACADEMIC_MODUL_ITEMS[] = "" . $CLUB_MANAGEMENT . "";
//            }
//        }
    ...
    private function administrationModul()
    {
        ...
        $SMS_MANAGEMENT = "{
            ...
            ,iconCls:'icon-phone'
            ,handler:function(){
                addTab('SMS_MANAGEMENT','" . ADMINISTRATION . " &raquo; " . SMS_MANAGEMENT . "','/academicsetting/smstabs/?key=" . camemisId() . "');
            }
        } ";
        ...
        $FINANCIAL_MANAGEMENT = "{
            ...
            ,handler: function(){
                addTab('FINANCIAL_MANAGEMENT','" . ADMINISTRATION . " &raquo; " . FINANCIAL_MANAGEMENT . "','/academicsetting/financetabs/?key=" . camemisId() . "');
            }
        } ";
        ...
        $SYSTEM_USER = "{
            ...
            ,iconCls:'icon-group_add'
            ,handler: function(){
                addTab('SYSTEM_USER','" . SYSTEM_USER . "','/academicsetting/systemusertabs/?key=" . camemisId() . "');
            }
        } ";
        ...
        $SCHOOL_SETTINGS = "{
            ...
            ,iconCls:'icon-wrench_orange'
            ,handler: function(){
                addTab('SCHOOL_SETTINGS','" . ADMINISTRATION . " &raquo; " . SCHOOL_SETTINGS . "','/academicsetting/schoolsettingtabs/?key=" . camemisId() . "');
            }
        } ";
