...
require_once 'models/app_school/finance/FinanceDescriptionDBAccess.php';
...
require_once 'models/app_school/finance/StaffFeePaymentDBAccess.php';
require_once 'models/app_school/finance/TaxDBAccess.php';
...
require_once 'models/app_school/finance/StudentFeePrepaidDBAccess.php'; //@veasna
require_once 'models/app_school/academic/AcademicLevelDBAccess.php'; //@veasna
require_once 'models/UserAuth.php';
...
class FinanceController extends Zend_Controller_Action {
    ...
    public function showexpensecategoryAction() {
        ...
        $this->view->objectId = $this->objectId;   
        $this->view->check =  ExpenseCategoryDBAccess::checkUsedExpenseCat($this->objectId); //@veasna
    ...
    public function studentfeesendreminderAction() {
        ...
        $this->view->str_recipient_email = $this->_getParam('objectemail');
        $this->view->str_recipient_phone = $this->_getParam('objectphone');
    ...
    public function showfeeenrollmentAction() {
        ...
        $this->view->incomeFee = IncomeDBAccess::findIncomeFromFeeId($this->objectId);
        $this->_helper->viewRenderer("fee/enrollment/show");
    }
    ...
    public function studentpaymenttrainingAction() {
        ...
        $this->view->objectId = $this->objectId;
        $object=StudentFeePrepaidDBAccess::findStudentPrePayment($this->objectId,true);
        $this->view->studentPrePaymentId=$object?$object->ID:'';
        $this->view->feePrePaymentId=$object?$object->FEE_PREPAYMENT_ID:'';
        $payment_type=($this->_getParam('payment_type'))?$this->_getParam('payment_type'):'';
       
        if($payment_type=='PRE_PAYMENT'){
            $this->_helper->viewRenderer("cash/student/studentprepaid/studentprepaymenttraining");
    ...
    public function jsonloadAction() {
        ...
        switch ($this->REQUEST->getPost('cmd')) {
            ...
            case "jsonLoadStudentFeeTrainingReminder":
                $jsondata = StudentPaymentSettingDBAccess::jsonLoadStudentFeeTrainingReminder($this->REQUEST->getPost());
                break;
