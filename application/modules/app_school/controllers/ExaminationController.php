...
class ExaminationController extends Zend_Controller_Action {
    ...
    public function enrollmentimportxlsAction() {
        ...
        $this->view->URL_TEMPLATE_XLS = $this->UTILES->buildURL('examination/enrollmenttemplatexls', array('academicId' => $this->objectId));
        $this->view->URL_STUDENT_IMPORT = $this->UTILES->buildURL('examination/enrollmentimportxls', array('academicId' => $this->objectId));
        $this->_helper->viewRenderer("enrollment/mainimportxls");
    }

    //@veasna
    public function enrollmentcandidateAction() {

        $this->view->objectId = $this->objectId;
        $this->_helper->viewRenderer("enrollment/candidatesetting");
    }
    ...
    public function enrollmentsettingcandidateAction() {

        $this->view->objectId = $this->objectId;
        $this->_helper->viewRenderer("enrollment/enrollcandidate");
    }
