...
class SubjectTeacherDBAccess extends SubjectDBAccess {
    ...
    public function checkAssignedSubjectTeacherClass($subjectId, $teacherId, $academicId, $term) {
    ...
    public function jsonLoadTeachersBySubject($params) {
        ...
        if($academicObject){
            $academicId = $academicObject ? $academicObject->ID : 0;
        }
    ...
    public static function jsonLoadTeachersBySubjectID($gradesubjectId, $subjectId, $academicId) {
    ...
    public static function jsonLoadTeacherSubjectDays($params) {
        ...
        if ($facette) {
            ...
            $data["SS_WEDNESDAY"] = isset($SS_CHECK_DAY["WEDNESDAY"])?true:false;
