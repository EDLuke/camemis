            ...
            foreach ($result as $value) {
                ...
                if ($academicObject->ENROLLMENT_TYPE == 1) {
                    ...
                    $data[$i]["SECOND_ACADEMIC"] = StudentAcademicDBAccess::checkDisplayStudentClassTermSchoolyear(
                                    ...
                                    , $academicObject
                                    , "SECOND_ACADEMIC");
                    $data[$i]["THIRD_ACADEMIC"] = StudentAcademicDBAccess::checkDisplayStudentClassTermSchoolyear(
                                    $value->ID
                                    , $academicObject
                                    , "THIRD_ACADEMIC");
                    $data[$i]["FOURTH_ACADEMIC"] = StudentAcademicDBAccess::checkDisplayStudentClassTermSchoolyear(
                                    $value->ID
                                    , $academicObject
                                    , "FOURTH_ACADEMIC");
                }
