...
require_once 'models/app_university/staff/StaffStatusDBAccess.php';
...
class StaffDBAccess {
    ...
    public function getSaffDataFromId($Id)
    {
        ...
        if ($result)
        {
            ...
            $data["SKIN"] = $USER_OBJECT ? $USER_OBJECT->SKIN : 'BLUE';
...
//        //What is this? Vibolrith. 30.05.2014
//        if (isset($campusId)) {
