...
class FeeDBAccess {
            ...
            if ($academicObject->EDUCATION_SYSTEM) {
                ...
                switch ($academicObject->OBJECT_TYPE) {
                    case "CAMPUS":
                        ...
                        break;
                    case "GRADE":
                        $SQL->joinLeft(array('B' => 't_subject'), 'B.ID=A.SUBJECT_ID', array("NAME AS SUBJECT_NAME"));
                        $SQL->where('A.GRADE_ID = ?', $node);
                        $SQL->where('A.SCHOOL_YEAR = ?', $facette->SCHOOLYEAR);
                        $SQL->where('A.OBJECT_TYPE = ?', "SUBJECT");
                        break;
                }
    ...
    public static function jsonSaveFee($params) {
        ...
        $amountOption = isset($params["AMOUNT_OPTION"]) ? $params["AMOUNT_OPTION"] : "";
        ...
        if ($facette) {
           ...
           /* if (isset($params["SCHOLARSHIP_A"]))
                $SAVEDATA["SCHOLARSHIP_A"] = $params["SCHOLARSHIP_A"];

            if (isset($params["SCHOLARSHIP_B"]))
                $SAVEDATA["SCHOLARSHIP_B"] = $params["SCHOLARSHIP_B"];

            if (isset($params["SCHOLARSHIP_C"]))
                $SAVEDATA["SCHOLARSHIP_C"] = $params["SCHOLARSHIP_C"];

            if (isset($params["SCHOLARSHIP_D"]))
                $SAVEDATA["SCHOLARSHIP_D"] = $params["SCHOLARSHIP_D"];
            ...
            if ($amountOption == 1) {
                ...
                if (isset($params["FIRST_AMOUNT"]))
                    $SAVEDATA["FIRST_AMOUNT"] = str2no($params["FIRST_AMOUNT"]);
                if (isset($params["FIRST_TOTAL"]))
                    $SAVEDATA["FIRST_TOTAL"] = str2no($params["FIRST_TOTAL"]);
            }

            if (isset($params["SECOND_AMOUNT"]))
                $SAVEDATA["SECOND_AMOUNT"] = str2no($params["SECOND_AMOUNT"]);

            if (isset($params["THIRD_AMOUNT"]))
                $SAVEDATA["THIRD_AMOUNT"] = str2no($params["THIRD_AMOUNT"]);

            if (isset($params["FOURTH_AMOUNT"]))
                $SAVEDATA["FOURTH_AMOUNT"] = str2no($params["FOURTH_AMOUNT"]);

            if (isset($params["SECOND_TOTAL"]))
                $SAVEDATA["SECOND_TOTAL"] = str2no($params["SECOND_TOTAL"]);

            if (isset($params["THIRD_TOTAL"]))
                $SAVEDATA["THIRD_TOTAL"] = str2no($params["THIRD_TOTAL"]);

            if (isset($params["FOURTH_TOTAL"]))
                $SAVEDATA["FOURTH_TOTAL"] = str2no($params["FOURTH_TOTAL"]);

            if (isset($params["FIRST_DES"]))
                $SAVEDATA["FIRST_DES"] = addText($params["FIRST_DES"]);

            if (isset($params["REMINDER"]))
                $SAVEDATA["REMINDER"] = addText($params["REMINDER"]);

            if (isset($params["REMINDER_TEXT"]))
                $SAVEDATA["REMINDER_TEXT"] = addText($params["REMINDER_TEXT"]);

            if (isset($params["SECOND_DES"]))
                $SAVEDATA["SECOND_DES"] = addText($params["SECOND_DES"]);

            if (isset($params["THIRD_DES"]))
                $SAVEDATA["THIRD_DES"] = addText($params["THIRD_DES"]);

            if (isset($params["FOURTH_DES"]))
                $SAVEDATA["FOURTH_DES"] = addText($params["FOURTH_DES"]);

            if (isset($params["FIRST_DUE_DATE_A"]))
                $SAVEDATA['FIRST_DUE_DATE_A'] = setDate2DB($params["FIRST_DUE_DATE_A"]);

            if (isset($params["SECOND_DUE_DATE_A"]))
                $SAVEDATA['SECOND_DUE_DATE_A'] = setDate2DB($params["SECOND_DUE_DATE_A"]);

            if (isset($params["SECOND_DUE_DATE_B"]))
                $SAVEDATA['SECOND_DUE_DATE_B'] = setDate2DB($params["SECOND_DUE_DATE_B"]);

            if (isset($params["THIRD_DUE_DATE_A"]))
                $SAVEDATA['THIRD_DUE_DATE_A'] = setDate2DB($params["THIRD_DUE_DATE_A"]);

            if (isset($params["THIRD_DUE_DATE_B"]))
                $SAVEDATA['THIRD_DUE_DATE_B'] = setDate2DB($params["THIRD_DUE_DATE_B"]);

            if (isset($params["THIRD_DUE_DATE_C"]))
                $SAVEDATA['THIRD_DUE_DATE_C'] = setDate2DB($params["THIRD_DUE_DATE_C"]);

            if (isset($params["FOURTH_DUE_DATE_A"]))
                $SAVEDATA['FOURTH_DUE_DATE_A'] = setDate2DB($params["FOURTH_DUE_DATE_A"]);

            if (isset($params["FOURTH_DUE_DATE_B"]))
                $SAVEDATA['FOURTH_DUE_DATE_C'] = setDate2DB($params["FOURTH_DUE_DATE_C"]);

            if (isset($params["FOURTH_DUE_DATE_C"]))
                $SAVEDATA['FOURTH_DUE_DATE_C'] = setDate2DB($params["FOURTH_DUE_DATE_C"]);

            if (isset($params["FOURTH_DUE_DATE_D"]))
                $SAVEDATA['FOURTH_DUE_DATE_D'] = setDate2DB($params["FOURTH_DUE_DATE_D"]);

            if (isset($params["DISCOUNT"]))
                $SAVEDATA["DISCOUNT"] = $params["DISCOUNT"];
            */
    ...
    // Student into Fee...
    ///////////////////////////////////////////////////
    /*public static function checkChildSchoolyearById($Id){
        $object=AcademicDateDBAccess::findAcademicDateFromId($Id);
        $SQL = self::dbAccess()->select();
        $SQL->from('t_academicdate', array('*'));
        $SQL->where("PARENT ='" . $object->INDEX_ID . "'");
