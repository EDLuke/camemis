...
//require_once 'models/app_school/student/StudentFeeDBAccess.php';
...
class StudentFeePrepaidDBAccess {
    ...
    public static function jsonSearchFeePrePayment($params) {
        ...
        if ($result) {
            ...
            foreach ($result as $value) {
                ...
                $data[$i]["TAX_CATEGORY"] = $value->ACCOUNT_NUMBER;
    ...
    public static function jsonSaveFeePrePayment($params) {
        ...
        if ($objectId == 'new') {
            ...
            $SAVEDATA["AMOUNT"] = displayNumberFormat($FEE_AMOUNT);
    ...
    public static function jsonLoadStudentPrePayment($params) {
        ...
        if ($facette) {
            ...
            $data['HIDDEN_FEES_AMOUNT'] = $facette->AMOUNT;
            ...
            if ($CHECK) {
                ...
                $data['DISCOUNT'] = $CHECK->DISCOUNT_PERCENT;
    ...
    public static function jsonActionStudentPrePayment($params) {
        ...
        $SAVEDATA['DISCOUNT_PERCENT'] = $discount_percent;
        $SAVEDATA['FORMULAR_TAX'] = $taxFormular;

        $SAVEDATA["INCOME_CATEGORY"] = $incomeCatagory;

        $SAVEDATA["FEE_PREPAYMENT"] = $feePrePaymentId;
