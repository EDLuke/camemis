...
class StudentAttendanceDBAccess extends StudentDBAccess {
    ...
    public function getAllAttendancesQuery($params)
    {
        ...
        if (strtoupper($target) != 'CREDITSYSTEM')
        { ///@veasna
            if ($campusId)
    ...
    protected function attendanceCountByClass($classId, $type, $subjectId)
    {
    ...
    public function jsonReleaseStudentAttendance($params)
    {
        ...
        if ($facette)
        {
            ...
            self::dbAccess()->update("t_student_attendance", $data, "ID='". $objectId ."'");
        }
    ...
    protected function checkExistingAttendanceDate($studentId, $classId, $trainingId, $startDate, $endDate)
    {
    ...
    ////////////////////////////////////////////////////////////////////////////
    //New...
    public function getCalculatedCountDate($start_date, $end_date, $classId, $schoolyearId, $trainingId)
    {
        ...
        if ($classId && $schoolyearId)
        {
            ...
            $paramsClassEvent['classId'] = $classId;
            ...
            $workingDays = $this->getStudentEduWorkingDays($classId);
    ...
    public static function jsonStudentAttendanceBlock($params)
    {
        ...
        if ($classObject)
        {
            $entries = StudentDBAccess::queryStudentByClass($classId, $classObject->SCHOOL_YEAR);
        }
    ...
    //New...
    ////////////////////////////////////////////////////////////////////////////
    public static function checkExistStudentBlockAttendance($studentId, $classId, $trainingId, $absentType, $absentDate)
    {
    ...
    public static function jsonStudentDailyAttendance($params)
    {
        ...
        if ($classId)
        {
            $term = AcademicDBAccess::getNameOfSchoolTermByDate($absentDate, $classId);
            if ($term != 'TERM_ERROR')
                ...
                if ($ABSENT_TYPES)
                {
                    foreach ($ABSENT_TYPES as $abentType)
                    {
                        ...
                        if ($scheduleObject)
                        {
                             ...
                             */
                            $CHECK_BLOCK = self::checkExistStudentBlockAttendance($studentId, $classId, $trainingId, $abentType->ID, $absentDate);
    ...
    ////////////////////////////////////////////////////////////////////////////
    public static function addStudentDailyAttendance($studentId, $absentDate, $absentType, $scheduleObject, $classId, $trainingId)
    {
    ...
    ////must find classId for student in scheduleId ....
