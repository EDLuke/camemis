...
require_once 'models/app_school/finance/FeeDBAccess.php'; //@veasna
require_once 'models/app_school/finance/StudentFeeDBAccess.php'; //@veasna
...
class StudentDBAccess {
    ...
    public function getStudentDataFromId($Id)
    {
        ...
        if ($result)
        {
            ...
            $data["SCHOOLYEAR"] = $CURRENT_ACADEMIC->SCHOOLYEAR;
            $data["ACADEMIC"] = $CURRENT_ACADEMIC->ACADEMIC;
            ...
            $data["REMARK_INFO"] = setShowText($result->REMARK_INFO);
