...
class GradeSubjectDBAccess extends SubjectDBAccess {
    ...
    public static function getListAcademicSubjects($academicObject) {
        if ($academicObject->EDUCATION_SYSTEM) {
            $entries = self::getListSubjectsToAcademic($academicObject->PARENT, false);
        } else {
            $entries = self::getListSubjectsToAcademic($academicObject->ID, false);
        }
