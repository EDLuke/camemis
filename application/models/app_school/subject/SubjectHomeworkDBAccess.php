...
class SubjectHomeworkDBAccess { 
    ...
    public static function getGradeSubjectHomework($objectId, $subjectId, $studentId, $globalSearch) {             
    ...
    public static function jsonLoadAllSubjectHomeworks($params) {
        ...
        */
        switch(UserAuth::getUserType()){
            case "SUPERADMIN":
            case "ADMIN":
                $result = self::getGradeSubjectHomework($gradesubjectId, $subjectId, $studentId, $globalSearch);
                break;
            case 'INSTRUCTOR':
            case 'TEACHER':
            case 'STUDENT':
