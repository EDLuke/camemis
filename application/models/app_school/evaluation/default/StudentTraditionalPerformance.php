...
//        parent::$this->section = $this->section;
    ...
    protected function getAvgYearClassPerformance($studentId) {
        $result = "---";
        switch (AcademicDBAccess::findAcademicTerm($this->classId)) {
            case 1:
                break;
            case 2:
                break;
    ...
    public static function getStudentYearAssessmentResult($studentId, $classId) {
    ...
    public static function getStudentTermAssessmentResult($studentId, $classId, $term) {
