...
require_once 'models/app_school/evaluation/default/AssessmentConfig.php';
...
class StudentAssignmentDBAccess {
    ...
    public function __construct($classId = false, $subjectId = false, $assignmentId = false)
    {
    ...
    {
        return StudentAcademicDBAccess::getQueryStudentEnrollment($this->classId, $globalSearch, false);
    }
    ...
    protected function checkStudentScoreSubjectAssignment()
    {
        ...
        $SQL->where("CLASS_ID = '" . $this->classId . "'");
    ...
    protected function setStudentScoreSubjectAssignment()
    {
        ...
        else
        {
            ...
            $SAVEDATA["CLASS_ID"] = $this->classId;
    ...
    public function jsonActionDeleteOneStudentTeacherScoreEnter($encrypParams)
    {
        ...
        $WHERE[] = self::dbAccess()->quoteInto('CLASS_ID = ?', $classId);
...
//    }
    ...
    protected function studentAvgAllAssignmentsBySubject($studentId, $subjectId, $term, $assignmentId, $setIncludeInValuation = false)
    {
        ...
        //error_log("Anzahl: ".count($entries));
