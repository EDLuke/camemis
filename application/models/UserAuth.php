...
class UserAuth {
    ...
    static function isDefaultSystemLanguage() {
        return (self::systemLanguage() == "ENGLISH") ? true : false;
    }
    ...
    static function getCountryEducation() {
        $value = Zend_Registry::get('SCHOOL')->COUNTRY_EDUCATION;
        return $value ? $value : "DEFAULT";
    }

    public static function getModulAPI() {
        return Zend_Registry::get('MODUL_API_PATH');
    }

    public static function isSchoolVersion() {
        return (self::getModulAPI() == "app_school") ? true : false;
    }

    public static function isUniVersion() {
        return (self::getModulAPI() == "app_university") ? true : false;
    }
