...
class CAMEMISConfig {
    ...
    static function setRegistryUserDB() {
        ...
        $params = array(
            'host' => "localhost",
            'username' => Zend_Registry::get('6E6B3F2E-NOK84-4CF8-922B-73D46B496E6B'),
            'password' => Zend_Registry::get('6E6B3F2E-SOCHEATA84-4CF8-922B-73D46B496E6B'),
            'dbname' => Zend_Registry::get('6E6B3F2E-SOTHEAROS84-4CF8-922B-73D46B496E6B')
        );
