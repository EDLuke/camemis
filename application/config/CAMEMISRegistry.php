...
class CAMEMISRegistry {
    ...
    static public function makeGeneralUserEduRegistry($MEMBER_OBJECT, $ACL_DATA, $USER_ROLE_OBJECT, $SESSION_OBJECT) {
        ...
        if ($MEMBER_OBJECT->ROLE == "STUDENT") {
            ...
            $DATA["STUDENT_SEARCH"] = true;
            $DATA["STUDENT_MODUL"] = true;
            $DATA["STUDENT_MODUL_READ_RIGHT"] = true;
            $DATA["STUDENT_MODUL_EDIT_RIGHT"] = true;
            $DATA["STUDENT_MODUL_REMOVE_RIGHT"] = false;
            $DATA["STUDENT_MODUL_EXECUTE_RIGHT"] = false;
            
            Zend_Registry::set('ACL', $DATA);
        } else {
